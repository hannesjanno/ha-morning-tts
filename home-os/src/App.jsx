...
const floors = {
  ...
  2: {
    ...
    doors: [
      ...
      { x:431.72, y:292, length:74, orientation:'v', swing:'right', hinge:'start' },
      { x:431.72, y:548, length:78, orientation:'v', swing:'right' },
      { x:346, y:659.18, length:78, orientation:'h', swing:'down' },
    ],
    stairs: { type:'straight', x:0, y:472, w:360, h:128, label:'Trepp ↑' },
    fixtures: [
