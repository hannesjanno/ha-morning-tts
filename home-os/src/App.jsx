...
const floors = {
  ...
  2: {
    ...
    rooms: [
      ...
      { id:'landing', name:'Trepihall', area:'11,4 m²', points:'0,381.56 256.23,381.56 256.23,659.18 0,659.18', label:[128,420] },
    ...
    stairs: { type:'straight', x:0, y:430, w:270, h:205, label:'Trepp ↑' },
    fixtures: [
